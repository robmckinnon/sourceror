...
defmodule VendoredSourceror.Code.Formatter do
  ...
  def equivalent(string1, string2) when is_binary(string1) and is_binary(string2) do
    quoted1 = :sourceror_elixir.string_to_quoted!(to_charlist(string1), 1, 1, "nofile", [])
    quoted2 = :sourceror_elixir.string_to_quoted!(to_charlist(string2), 1, 1, "nofile", [])
  ...
  defp gather_followup_comments(
         line,
         _,
         [%{line: line, previous_eol_count: previous_eol_count} = comment | comments],
         doc
       )
